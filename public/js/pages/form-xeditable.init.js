$(function () { 
    ...
    $("#inline-sex").editable({ 
        ...
        display: function (t, e) { 
            ...
            e.length ? $(this).text(e[0].text).css("color", { "": "#98a6ad", 1: "#5fbeaa", 2: "#5d9cec" }[t]) : $(this).empty() 
        } 
    }), 
    $("#inline-group").editable({ 
        showbuttons: !1, mode: "inline", inputclass: "form-select form-select-sm" 
    }), 
    $("#inline-dob").editable({ 
        mode: "inline", inputclass: "form-select form-select-sm" 
    }), 
    $("#inline-comments").editable({ 
        showbuttons: "bottom", mode: "inline", inputclass: "form-control-sm" 
    }) 
});